...
{
    public partial class MyCloudApplicationNew : Form
    {
        public MyCloudApplicationNew()
        {
            InitializeComponent();
        }
        ...
        private void lbStaff_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Delete)
            {
                for (int i = lbStaff.SelectedIndices.Count - 1; i >= 0; i--)
                    lbStaff.Items.RemoveAt(lbStaff.SelectedIndices[i]);
            }
        }
    }
}
